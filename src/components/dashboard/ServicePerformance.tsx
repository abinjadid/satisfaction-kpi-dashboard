...
/** قائمة الخدمات الأعلى/الأدنى أداءً مع أشرطة تقدّم. */
export function ServicePerformance({ services, variant }: ServiceListProps) {
  ...
  return (
    <ul className="flex flex-col gap-3">
      {services.map((s, i) => (
        <li key={s.serviceType} className="flex items-center gap-3">
          <span
            className={cn(
